import 'package:black_whales/persentation/features/MainCategory/TabsUi/following/widgets/following_list_cell.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Center(
          child: Wrap(
              children: List.generate(lables.length, (index) {
